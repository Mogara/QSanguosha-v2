...
return {
	...
	["fengliang"] = "逢亮",
	[":fengliang"] = "觉醒技。当你进入濒死状态时，你减一点体力上限并将体力值恢复至2点，然后获得技能”挑衅”，将技能“困奋”改为非锁定技。”",
    
    ["jsp_zhaoyun"] = "J.SP赵云" ,
    ["&jsp_zhaoyun"] = "赵云" ,
    ["#jsp_zhaoyun"] = "常山的游龙" ,
    [":chixin"] = "你可将一张♦牌当【杀】或【闪】使用或打出。出牌阶段，你对此阶段内你没有对其使用过【杀】的角色使用【杀】无次数限制。" ,
...
●装备牌，你使用【杀】指定目标角色后，其弃置两张牌。",
	...
	["lifeng"] = "李丰",
	["tunchu"] = "屯储",
	[":tunchu"] = "摸牌阶段摸牌时，你可以额外摸两张牌，如何将一张手牌置于你的武将牌上，称为“粮”。锁定技，若你的武将牌上有“粮”，你不能使用【杀】和决斗。",
