...
return {
	...
	["YitianSword:yes"] = "你可以选择一名其他角色，对其造成【倚天剑】造成的1点伤害。",
	["yitian-lost"] = "倚天剑",
	["@yitian-sword"] = "您在回合外获得了一张【杀】，您可以此时使用此【杀】",
	...
	["weiwudi_guixin:obtain"] = "获得一个未加入游戏的武将牌上的主公技",
	...
	["xiahoujuan"] = "夏侯涓",
	["lianli"] = "连理",
	[":lianli"] = "准备阶段开始时，你可以选择一名男性角色，你与其进入连理状态直到你的下回合开始：其可以替你使用或打出【闪】，你可以替其使用或打出【】",
	["tongxin"] = "同心",
	...
	["lianlislash"] = "连理（杀）",
	["lianli-jink"] = "连理（闪）",
	["lianli-slash:slash"] = "请选择是否是否需要你的连理角色替你使用或打出【杀】？",
	["lianli-jink:jink"] = "请选择是否是否需要你的连理角色替你使用或打出【闪】？",
	...
	[风]一名角色受到的火属性伤害时，此伤害+1。\
	[雷]一名角色受到的雷属性伤害时，此伤害+1。\
	...
	["wuling:wind"] = "[风]一名角色受到的火属性害时，此伤害+1",
	["wuling:thunder"] = "[雷]一名角色受到的雷属性伤害+1",
	...
	["caizhaoji_hujia"] = "胡笳",
	[":caizhaoji_hujia"] = "结束阶段开始时，你可以进行一次判定：若结果为红色，你获得此判定牌，若如此做，你可以重复此流程。若你在一个阶段内发动“胡笳”获得过至少三张牌，你将武将牌翻面。",
	...
	["xunzhi"] = "殉志",
	[":xunzhi"] = "出牌阶段，你可以摸三张牌，然后变身为其他未上场或已阵亡的蜀势力角色，若如此做，回合结束后，你死亡。",
	...
	["dengshizai"] = "邓士载",
	["zhenggong"] = "争功",
	[":zhenggong"] = "其他角色的回合开始前，若你的武将牌正面朝上，你获得一个额外的回合，此回合结束后，你将武将牌翻面。",
	["toudu"] = "偷渡",
	...
	["zhanggongqi"] = "张公祺",
	["yishe"] = "义舍",
	[":yishe"] = "出牌阶段，你可以将一至五张手牌置于你的武将牌上称为【米】或获得至少一张“米”；其他角色的<font color=\"green\"><b>出牌阶段限两次，</b></font>其可选择一张“米”，你可以将之交给其。",
	["xiliang"] = "惜粮",
	...
	["ytzhenwei"] = "镇威",
	[":ytzhenwei"] = "每当你使用的【杀】被其他角色使用手牌中的【闪】抵消时，你可以获得此【闪】。",
	["yitian"] = "倚天",
	[":yitian"] = "<b>联动技</b>，每当当你对曹操造成伤害时，你可以令该伤害-1。",
