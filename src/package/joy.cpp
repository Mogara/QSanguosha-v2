...
public:
    ...
    bool isEnabledAtPlay(const Player *player) const
    {
        ...
        switch (hp) {
        case 1:
            return !player->hasUsed("NosRendeCard");
            break;
        case 2:
            return false; // Trigger Skill
            break;
        case 3:
            ...
            break;
        case 4:
            return !player->hasUsed("NosGuoseCard");
            break;
        case 5:
...
public:
    ...
    {
        CardUseStruct use = data.value<CardUseStruct>();
        const TriggerSkill *jz = Sanguosha->getTriggerSkill("nosjizhi");
        if (use.card != NULL && use.card->isNDTrick() && jz != NULL)
...
void FiveLines::onInstall(ServerPlayer *player) const
{
    ...
    skills << Sanguosha->getTriggerSkill("nosrende") << Sanguosha->getTriggerSkill("nosguose");
